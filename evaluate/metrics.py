...
metrics.py
----------
Two evaluation metrics for TTS benchmarking:

  1. WER  - Word Error Rate        (lexical, word level)
  2. CER  - Character Error Rate   (lexical, char level — better for Indic scripts)

Lower WER/CER = better TTS quality.
Higher word_accuracy/char_accuracy = better TTS quality.
"""
...
def score_all(original: str, transcribed: str, api_key: str = None) -> dict:
    """
    Run all metrics and return a single merged dict.
